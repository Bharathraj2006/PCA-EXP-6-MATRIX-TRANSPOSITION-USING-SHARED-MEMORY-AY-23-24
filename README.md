...
![alt text](<output/Screenshot 2025-10-30 090819.png>)
![alt text](<output/Screenshot 2025-10-30 090838.png>)
![alt text](<output/Screenshot 2025-10-30 090853.png>)

## RESULT:
Thus the program has been executed by using CUDA to transpose a matrix. It is observed that there are variations shared memory and global memory implementation. The elapsed times are recorded as 0.003862 sec.
